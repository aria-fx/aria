...
- "ARIA is TOGAF for AI assets — a metamodel, a marketplace, and a governance layer."
- "The OASF Record and governance overlay travel with the asset — in every PR, in every OCI artifact, in every runtime."
- "Governance is a natural consequence of building, not an afterthought."
- "The sensitivity ceiling check that runs in CI is the same check that runs at runtime in the agent middleware. One rule, enforced everywhere."
